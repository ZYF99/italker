...
import com.zyf.italker.italker.frags.account.AccountTrigger;
import com.zyf.italker.italker.frags.account.LoginFragment;
import com.zyf.italker.italker.frags.account.RegisterFragment;
...
public class AccountActivity extends Activity implements AccountTrigger {
    ...
    public void triggerView() {
        ...
        if (mCurFragment == mLoginFragment) {
            ...
            //因为默认情况下mLoginFragment已经赋值，无需判空
