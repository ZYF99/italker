...
import com.zyf.italker.common.app.ToolbarActivity;
import com.zyf.italker.italker.R;
import com.zyf.italker.italker.frags.search.SearchGroupFragment;
import com.zyf.italker.italker.frags.search.SearchUserFragment;
...
public class SearchActivity extends ToolbarActivity {
     ...
     */
    static void show(Context context, int type) {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        //这个SearchView是在菜单布局中设置的 menu中app:actionViewClass="android.support.v7.widget.SearchView"
        ...
        if (searchView != null) {
            ...
            searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
                ...
                public boolean onQueryTextChange(String s) {
                    //当字体改变的时候，我们不会及时搜索，只在为null的情况下进行搜索
