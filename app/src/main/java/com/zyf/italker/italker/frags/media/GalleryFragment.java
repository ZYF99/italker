package com.zyf.italker.italker.frags.media;
...
public class GalleryFragment extends BottomSheetDialogFragment
    ...
    private static class TransStausBottomSheetDialog extends BottomSheetDialog {
        ...
        public TransStausBottomSheetDialog(@NonNull Context context, int theme) {
            super(context, theme);
        }

        protected TransStausBottomSheetDialog(@NonNull Context context, boolean cancelable, OnCancelListener cancelListener) {
